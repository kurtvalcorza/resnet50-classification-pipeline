...
`tutorials/resnet50_classification_colab.ipynb` (`TASK-INFERENCE`) is a **release candidate** until
...
- the profile-specific public-API calls (`stage_missing_files`, `verify_snapshot`,
  `ResNet50ClassificationPipeline.from_pretrained(weights_dir=...)`, `predict`, `top_k_accuracy`), the ceiling print (`NUM_CLASSES`, `MAX_IMAGE_SIDE`, `MAX_BATCH`),
