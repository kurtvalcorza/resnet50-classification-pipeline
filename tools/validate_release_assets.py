...
CODE_MARKERS = (
    ...
    'from resnet50_classification_pipeline import MODEL_ID, MODEL_KEY, MODEL_REVISION, '
    'ResNet50ClassificationPipeline, stage_missing_files, top_k_accuracy, verify_snapshot',
