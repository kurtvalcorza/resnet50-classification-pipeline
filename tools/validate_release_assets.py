...
WORKSHOP_NOTEBOOK_NAME = "DIMER_Modern_Image_Classification_Workshop.ipynb"
...
EXPECTED_OUTPUTS = (
    "outputs/resnet50_classification_input_manifest.json",
    "outputs/resnet50_classification_evaluation_report.json",
    "outputs/resnet50_classification_result.json",
    "outputs/resnet50_classification_top_k.csv",
    "outputs/resnet50_classification_finetuned/model.safetensors",
    "outputs/resnet50_classification_finetuned/model-config.json",
)
...
CODE_MARKERS = (
    ...
    "'device': pipe.device",
    "pipe.fit(",
    "reloaded_pipe = ResNet50ClassificationPipeline.from_pretrained(weights_dir=",
)
